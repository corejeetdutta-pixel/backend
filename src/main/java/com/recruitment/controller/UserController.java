...
public class UserController {
    ...
    public ResponseEntity<?> register(@RequestBody UserDto dto) {
        try {
            ...
            try {
                String frontendUrl = "https://backend-n4w7.onrender.com"; // Change to your actual frontend URLhttps://backend-n4w7.onrender.com
    ...
    public ResponseEntity<?> verifyEmail(@RequestParam String token) {
        try {
            ...
            if (user.isEmailVerified()) {
                System.out.println("Email already verified: " + user.getEmail());
    ...
    public ResponseEntity<?> resendVerification(@RequestParam String email) {
        try {
            ...
            // Resend verification email
            try {
                String frontendUrl = "https://backend-n4w7.onrender.com"; // Change to your actual frontend URL
